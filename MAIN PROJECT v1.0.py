...
bg_im1=PhotoImage(file="my.png")
label_bg=Label(root,image=bg_im1)
...
frame_a=Frame(root)
label_1=Label(frame_a,text="CATIA V5 Automation using Python Script",bd=15,relief="groove",font="Times 42 bold",fg="#040214",bg="#e3770b",width=41,height=1)
frame_a.grid(row=0,column=0,columnspan=2)
...
knuckle_label.grid(row=1,column=0)
gib_label.grid(row=1,column=1)
...
gtensile_label.place(x=730,y=300)
...
gshear_label.place(x=730,y=400)
...
gfolder_label.place(x=730,y=500)
