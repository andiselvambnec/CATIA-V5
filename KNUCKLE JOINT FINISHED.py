...
universal_label=Label(root,text="UNIVERSAL JOINT",bd=15,relief="ridge",font="Vertana 32 bold",fg="#6e0404",bg="#cfa336",width=15,height=1)
knuckle_label.grid(row=1,column=0)
universal_label.grid(row=1,column=1)
...
knuckle_button=Button(root,text=" CALCULATE ",padx=10,pady=10,fg="black",bg="green",font="Times 20 bold",bd=15,command=unitkp)
